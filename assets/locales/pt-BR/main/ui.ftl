...
editor-debug-recording-tooltip = Somente builds de desenvolvimento: também grava o áudio bruto do microfone em assets/debug_sounds/<song>/ ao salvar, para diagnosticar problemas de detecção de tom depois
