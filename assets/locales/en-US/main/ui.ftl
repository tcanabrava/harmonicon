...
editor-debug-recording-tooltip = Dev builds only: also record the take's raw microphone audio to assets/debug_sounds/<song>/ on Save, for diagnosing pitch-detection issues later
