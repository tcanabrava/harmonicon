...
editor-debug-recording-tooltip = Solo en builds de desarrollo: también graba el audio bruto del micrófono en assets/debug_sounds/<song>/ al guardar, para diagnosticar problemas de detección de tono más tarde
